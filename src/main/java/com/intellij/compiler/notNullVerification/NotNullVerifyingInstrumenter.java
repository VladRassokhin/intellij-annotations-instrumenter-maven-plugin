    ...
    public MethodVisitor visitMethod(final int access, final String name, final String desc, final String signature, final String[] exceptions) {
        ...
        return new MethodVisitor(Opcodes.ASM5, v) {
            ...
            public AnnotationVisitor visitParameterAnnotation(final int parameter, final String annotation, final boolean visible) {
                ...
                if (isReferenceType(args[parameter]) && annotation.equals(NOT_NULL_ANNO)) {
            ...
            public AnnotationVisitor visitAnnotation(final String annotation, final boolean isRuntime) {
                final AnnotationVisitor av = mv.visitAnnotation(annotation, isRuntime);
                if (isReferenceType(returnType) && annotation.equals(NOT_NULL_ANNO)) {
                    myIsNotNull = true;
                }
            ...
            public void visitCode() {
                ...
                for (final Integer myNotNullParam : myNotNullParams) {
                    ...
                    final int param = myNotNullParam;
